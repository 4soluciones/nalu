...
def ensure_service_serials(subsidiary, company, serials_map=None):
    """Crea filas de serie para todos los servicios. serials_map: {(service_type, doc_type): serial}."""
...
def serials_form_context(subsidiary, company):
    ...
    return {
        ...
        'serial_mudanza': _serial('M', 'T'),
        'serial_delivery': _serial('D', 'T'),
        'serial_carga': _serial('C', 'T'),
