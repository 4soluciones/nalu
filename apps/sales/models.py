...
class OrderMoving(models.Model):
    order = models.OneToOneField(Order, on_delete=models.CASCADE, related_name='moving')
    origin_address = models.CharField(max_length=300, blank=True, default='')
    origin_property_type = models.CharField(
        max_length=1, choices=PROPERTY_TYPE_CHOICES, blank=True, default='C',
    )
    origin_floors = models.PositiveSmallIntegerField(default=1)
    destination_address = models.CharField(max_length=300, blank=True, default='')
    dest_property_type = models.CharField(
        max_length=1, choices=PROPERTY_TYPE_CHOICES, blank=True, default='C',
    )
    dest_floors = models.PositiveSmallIntegerField(default=1)
    service_date = models.DateField(null=True, blank=True)
    service_time = models.TimeField(null=True, blank=True)
    helpers_count = models.PositiveSmallIntegerField(default=0)
    fare_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    payment_method = models.CharField(max_length=1, choices=PAYMENT_METHOD_CHOICES, blank=True, default='E')
...
class OrderDelivery(models.Model):
    ...
    pickup_address = models.CharField(max_length=300, blank=True, default='')
    ...
    dest_reference = models.CharField(max_length=250, blank=True, default='')
    fare_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    payment_method = models.CharField(max_length=1, choices=PAYMENT_METHOD_CHOICES, blank=True, default='E')
...
class OrderCharge(models.Model):
    ...
    client_ruc = models.CharField(max_length=11, blank=True, default='')
    client_name = models.CharField(max_length=200, blank=True, default='')
    origin_address = models.CharField(max_length=300, blank=True, default='')
    origin_contact = models.CharField(max_length=120, blank=True, default='')
    origin_phone = models.CharField(max_length=20, blank=True, default='')
    dest_address = models.CharField(max_length=300, blank=True, default='')
    dest_contact = models.CharField(max_length=120, blank=True, default='')
    dest_phone = models.CharField(max_length=20, blank=True, default='')
