...
(function ($) {
    ...
    $('.nalu-nav > li.has-submenu').on('mouseenter', function () {

        clearTimeout(submenuTimer);

        $('.nalu-nav > li.has-submenu').not(this).removeClass('submenu-open');
    ...
    function markActiveNav() {
        ...
        $('.nalu-nav .submenu a, .nalu-mobile-nav a[href]').each(function () {
        ...
        if (bestMatch) {
            ...
            $(bestMatch).closest('.nalu-nav > li.has-submenu').addClass('is-current-section');
    ...
    var $toggle = $('#nalu-menu-toggle');

    var $nav = $('#nalu-mobile-nav');
